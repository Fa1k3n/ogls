...
{
    return getMock()->gl_BlendEquationSeparate(modeRGB, modeAlpha);
}
...
{
    return getMock()->gl_DisableVertexAttribArray(index);
}
...
{
    return getMock()->gl_EnableVertexAttribArray(index);
}
...
{
    return getMock()->gl_GetVertexAttribPointerv(index, pname, pointer);
}
...
{
    return getMock()->gl_GetVertexAttribdv(index, pname, params);
}
...
{
    return getMock()->gl_GetVertexAttribfv(index, pname, params);
}
...
{
    return getMock()->gl_GetVertexAttribiv(index, pname, params);
}
...
{
    return getMock()->gl_ShaderSource(shader, count, string, length);
}
...
{
    return getMock()->gl_StencilMaskSeparate(face, mask);
}
...
{
    return getMock()->gl_BeginConditionalRender(id, mode);
}
...
{
    return getMock()->gl_BeginTransformFeedback(primitiveMode);
}
...
{
    return getMock()->gl_BindFragDataLocation(program, colorNumber, name);
}
...
{
    return getMock()->gl_ClampColor(target, clamp);
}
...
{
    return getMock()->gl_ClearBufferfi(buffer, drawBuffer, depth, stencil);
}
...
{
    return getMock()->gl_ClearBufferfv(buffer, drawBuffer, value);
}
...
{
    return getMock()->gl_ClearBufferiv(buffer, drawBuffer, value);
}
...
{
    return getMock()->gl_ClearBufferuiv(buffer, drawBuffer, value);
}
...
{
    return getMock()->gl_GetBooleani_v(pname, index, data);
}
...
{
    return getMock()->gl_GetFragDataLocation(program, name);
}
...
{
    return getMock()->gl_GetStringi(name, index);
}
...
{
    return getMock()->gl_GetTexParameterIiv(target, pname, params);
}
...
{
    return getMock()->gl_GetTexParameterIuiv(target, pname, params);
}
...
{
    return getMock()->gl_GetTransformFeedbackVarying(program, index, bufSize, length, size, type, name);
}
...
{
    return getMock()->gl_GetUniformuiv(program, location, params);
}
...
{
    return getMock()->gl_GetVertexAttribIiv(index, pname, params);
}
...
{
    return getMock()->gl_GetVertexAttribIuiv(index, pname, params);
}
...
{
    return getMock()->gl_IsEnabledi(cap, index);
}
...
{
    return getMock()->gl_TexParameterIiv(target, pname, params);
}
...
{
    return getMock()->gl_TexParameterIuiv(target, pname, params);
}
...
{
    return getMock()->gl_TransformFeedbackVaryings(program, count, varyings, bufferMode);
}
...
{
    return getMock()->gl_Uniform1ui(location, v0);
}
...
{
    return getMock()->gl_Uniform2uiv(location, count, value);
}
...
{
    return getMock()->gl_Uniform3ui(location, v0, v1, v2);
}
...
{
    return getMock()->gl_Uniform3uiv(location, count, value);
}
...
{
    return getMock()->gl_Uniform4ui(location, v0, v1, v2, v3);
}
...
{
    return getMock()->gl_VertexAttribI1iv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI1ui(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI1uiv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI2i(index, v0, v1);
}
...
{
    return getMock()->gl_VertexAttribI2iv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI2ui(index, v0, v1);
}
...
{
    return getMock()->gl_VertexAttribI2uiv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI3i(index, v0, v1, v2);
}
...
{
    return getMock()->gl_VertexAttribI3iv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI3ui(index, v0, v1, v2);
}
...
{
    return getMock()->gl_VertexAttribI3uiv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI4bv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI4i(index, v0, v1, v2, v3);
}
...
{
    return getMock()->gl_VertexAttribI4iv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI4sv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI4ubv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI4ui(index, v0, v1, v2, v3);
}
...
{
    return getMock()->gl_VertexAttribI4uiv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribI4usv(index, v0);
}
...
{
    return getMock()->gl_VertexAttribIPointer(index, size, type, stride, pointer);
}
...
{
    return getMock()->gl_DrawArraysInstanced(mode, first, count, primcount);
}
...
{
    return getMock()->gl_DrawElementsInstanced(mode, count, type, indices, primcount);
}
...
{
    return getMock()->gl_PrimitiveRestartIndex(buffer);
}
...
{
    return getMock()->gl_TexBuffer(target, internalFormat, buffer);
}
...
{
    return getMock()->gl_FramebufferTexture(target, attachment, texture, level);
}
...
{
    return getMock()->gl_GetBufferParameteri64v(target, value, data);
}
...
{
    return getMock()->gl_GetInteger64i_v(pname, index, data);
}
...
{
    return getMock()->gl_GetGraphicsResetStatus();
}
...
{
    return getMock()->gl_GetnCompressedTexImage(target, lod, bufSize, pixels);
}
...
{
    return getMock()->gl_GetnTexImage(tex, level, format, type, bufSize, pixels);
}
...
{
    return getMock()->gl_GetnUniformdv(program, location, bufSize, params);
}
PFNGLGETNUNIFORMDVPROC __glewGetnUniformdv = mockgl_GetnUniformdv;

void  mockgl_MultiDrawArraysIndirectCount(GLenum mode, const GLvoid * indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride)
{
    return getMock()->gl_MultiDrawArraysIndirectCount(mode, indirect, drawcount, maxdrawcount, stride);
}
PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC __glewMultiDrawArraysIndirectCount = mockgl_MultiDrawArraysIndirectCount;

void  mockgl_MultiDrawElementsIndirectCount(GLenum mode, GLenum type, const GLvoid * indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride)
{
    return getMock()->gl_MultiDrawElementsIndirectCount(mode, type, indirect, drawcount, maxdrawcount, stride);
}
PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC __glewMultiDrawElementsIndirectCount = mockgl_MultiDrawElementsIndirectCount;

void  mockgl_SpecializeShader(GLuint shader, const GLchar * pEntryPoint, GLuint numSpecializationConstants, const GLuint * pConstantIndex, const GLuint * pConstantValue)
{
    return getMock()->gl_SpecializeShader(shader, pEntryPoint, numSpecializationConstants, pConstantIndex, pConstantValue);
}
PFNGLSPECIALIZESHADERPROC __glewSpecializeShader = mockgl_SpecializeShader;
